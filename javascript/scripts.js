...
function toggleTime(tableNum) {
    var button = document.getElementById("s" + tableNum);
...
function addTable() {
    ...
    var buttonsClass = document.createAttribute("class");
    buttonsClass.value = "buttons";
    buttons.setAttributeNode(buttonsClass);
    
    var buttonClass = document.createAttribute("class");
    buttonClass.value = "btn";

    var startButton = document.createElement("button");
    var sButtonId = document.createAttribute("id");
    sButtonId.value = "s"+tableNum;
    var clickAtt = document.createAttribute("onclick");
    clickAtt.value = "toggleTime(" + tableNum + ");";
    startButton.setAttributeNode(clickAtt);
    startButton.setAttributeNode(sButtonId);
    startButton.setAttributeNode(buttonClass);
